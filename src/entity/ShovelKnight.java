...
public class ShovelKnight extends Entity{
	ImageView imageView;
	Animation animation;
	private static final int HEALTHPOINTS = 250; // Determines if the monster is still alive
    private static final int SPEED = 1;         // Determines time to complete path
    private static final int REWARD = 100;       // Monster death will trigger a resource reward
...
/////////////////////////////////////// Player Animation //////////////////////////////////////
	...
	private static final String image_path = ClassLoader.getSystemResource("Shovel Knight.png").toString();
